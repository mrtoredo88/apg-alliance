/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/telegram-relay/wrangler.jsonc cloudflare/telegram-relay/worker-configuration.d.ts` (hash: 66db61acfc1c33f7960a172369e6304c)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	BACKEND_WEBHOOK_URL: "https://bbangqkf2d4pa9855lu0.containers.yandexcloud.net/api/telegram-webhook";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_WEBHOOK_URL" | "TELEGRAM_BOT_TOKEN" | "WEBHOOK_SECRET" | "BACKEND_SECRET" | "RELAY_SECRET">> {}
}
