...
Полностью обновили мобильную главную страницу: теперь рядом с вами проще находить интересные места, акции, события, новости и экспертов. Главный баннер автоматически показывает актуальные предложения, а светлая и тёмная темы снова отображаются корректно.
...
- исправлено открытие полного каталога по кнопке «Места»;
- улучшена видимость кнопок нижней навигации;
...
Новая главная, светлая и тёмная темы, стабильная авторизация и улучшенные разделы приложения.
