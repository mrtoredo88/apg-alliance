...
const EXECUTIONS = [
  ...
  { capability: 'OPEN_DIALOG', mode: EXECUTION_MODES.NAVIGATION, navigation: route('profile', '/profile#dialogs'), actionId: ACTION_IDS.OPEN_DIALOG, actionType: LOKI_APP_ACTIONS.OPEN_LOKI, requiredParameters: ['dialogId'] },
  { capability: 'SEND_MESSAGE', mode: EXECUTION_MODES.ACTION_CENTER, navigation: route('profile', '/profile#dialogs'), actionId: ACTION_IDS.OPEN_DIALOG, actionType: LOKI_APP_ACTIONS.OPEN_LOKI, requiredParameters: ['recipientId', 'messageText'] },
  { capability: 'VIEW_FRIENDS', mode: EXECUTION_MODES.NAVIGATION, navigation: route('profile', '/profile#friends'), actionId: ACTION_IDS.OPEN_PROFILE, actionType: LOKI_APP_ACTIONS.SHOW_PROFILE, toolIds: [TOOL_IDS.USER_PROFILE], requiredParameters: [] },
  ...
  { capability: 'SEARCH_PARTNERS', mode: EXECUTION_MODES.TOOL, navigation: route('partners', '/partners?query=:query'), actionId: ACTION_IDS.SEARCH, actionType: LOKI_APP_ACTIONS.OPEN_PARTNERS, toolIds: [TOOL_IDS.SEARCH, TOOL_IDS.PARTNER_FIND], workflowId: 'partner', requiredParameters: ['query'] },
  ...
  { capability: 'SEARCH_PROMOTIONS', mode: EXECUTION_MODES.TOOL, navigation: route('offers', '/offers?query=:query'), actionId: ACTION_IDS.OPEN_PROMOTION, actionType: LOKI_APP_ACTIONS.OPEN_PARTNERS, toolIds: [TOOL_IDS.SEARCH, TOOL_IDS.PROMOTION_ACTIVE], requiredParameters: ['query'] },
