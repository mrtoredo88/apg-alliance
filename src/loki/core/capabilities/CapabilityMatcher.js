...
const SYNONYMS = {
  ...
  VIEW_FRIENDS: ['люди', 'друзья', 'знакомые', 'контакты'],
  SEARCH_PEOPLE: ['найди человека', 'найди татьяну', 'найди анну', 'найди максима', 'поиск людей', 'участник апг'],
  ADD_FRIEND: ['добавь в друзья', 'отправь заявку', 'подружиться', 'добавь'],
