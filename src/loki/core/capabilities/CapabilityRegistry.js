...
const CAPABILITIES = [
  ...
  { id: 'VIEW_FRIENDS', title: 'Показать людей', description: 'Показать друзей, заявки, диалоги и поиск людей.', aliases: ['люди', 'друзья', 'знакомые', 'контакты', 'мои друзья', 'покажи друзей'], requiredParameters: [], optionalParameters: [], requiredRole: 'user', requiredTools: ['user'], relatedScreens: ['profile'], priority: 78, category: CAPABILITY_CATEGORIES.SOCIAL },
  { id: 'SEARCH_PEOPLE', title: 'Найти человека', description: 'Найти участника АПГ по имени, компании, роли или городу.', aliases: ['найди человека', 'найди татьяну', 'найди анну', 'найди максима', 'поиск людей', 'найти участника'], requiredParameters: ['query'], optionalParameters: [], requiredRole: 'user', requiredTools: ['user', 'search'], relatedScreens: ['profile'], priority: 86, category: CAPABILITY_CATEGORIES.SOCIAL },
  { id: 'ADD_FRIEND', title: 'Добавить в друзья', description: 'Открыть карточку участника и отправить заявку на знакомство.', aliases: ['добавь в друзья', 'добавь максима', 'подружиться', 'отправь заявку'], requiredParameters: ['userId'], optionalParameters: ['query'], requiredRole: 'user', requiredTools: ['user'], relatedScreens: ['profile'], priority: 84, category: CAPABILITY_CATEGORIES.SOCIAL },
