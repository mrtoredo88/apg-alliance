...
export const ACTION_REGISTRY = [
  ...
  { id: ACTION_IDS.OPEN_PEOPLE, type: LOKI_APP_ACTIONS.OPEN_PEOPLE, label: 'Открыть Люди', category: 'navigation', entity: 'people', payloadKeys: ['query', 'userId'], intents: ['social.people', 'social.friend', 'social.message'], goals: ['CONNECT'] },
