...
function PrizeCard({ prize, userKeys, onClaim, isClaimed, index }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: 24,
      padding: 16,
      border: `1px solid ${isClaimed ? 'rgba(75,179,75,0.3)' : outOfStock ? 'rgba(255,255,255,0.13)' : canAfford ? 'rgba(201,168,76,0.22)' : 'rgba(255,255,255,0.13)'}`,
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 12 }}>
        <div style={{
          ...
          background: isClaimed ? 'rgba(75,179,75,0.12)' : outOfStock ? 'rgba(255,255,255,0.04)' : 'rgba(201,168,76,0.1)',
        ...
        {!isClaimed && outOfStock && (
          <div style={{ fontSize: 10, fontWeight: 700, color: T.textSec, background: 'rgba(255,255,255,0.05)', border: `1px solid ${T.border}`, borderRadius: 8, padding: '3px 8px', flexShrink: 0, whiteSpace: 'nowrap' }}>
            РАЗОБРАНО
          </div>
        )}
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{
          flex: 1,
          background: canAfford && !unavailable ? 'rgba(201,168,76,0.08)' : 'rgba(255,255,255,0.04)',
