...
export const APG2_PROFILE = {
  ...
  glass: {
    background: 'radial-gradient(circle at 18% 0%,rgba(var(--apg2-glass-a,255,255,255),0.18),transparent 34%), linear-gradient(145deg,rgba(var(--apg2-glass-a,255,255,255),0.15),rgba(var(--apg2-glass-a,255,255,255),0.055))',
    backdropFilter: 'blur(36px) saturate(1.62)',
    WebkitBackdropFilter: 'blur(36px) saturate(1.62)',
    border: '1px solid var(--apg2-glass-border, rgba(255,255,255,0.19))',
    boxShadow: 'inset 0 1px 0 rgba(var(--apg2-glass-a,255,255,255),0.26), inset 0 -22px 44px rgba(var(--apg2-glass-a,255,255,255),0.04), 0 24px 70px var(--apg2-elev-shadow, rgba(0,0,0,0.34))',
  },
  goldGlass: {
  ...
  return (
    <input
      ...
      style={{
        ...
        background: 'rgba(var(--apg2-glass-a,255,255,255),0.10)',
        fontSize: 16,
        lineHeight: '20px',
        fontWeight: 650,
        fontFamily: 'inherit',
