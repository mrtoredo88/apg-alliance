  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const specs = [
        ...
        { name: 'notifications', label: 'Уведомления', load: () => fetchAdminEntityList('notifications', 1000) },
        { name: 'prizes', label: 'Призы', ref: () => query(collection(db, 'prizes'), orderBy('cost', 'asc')) },
        { name: 'customTasks', label: 'Задания', load: () => fetchAdminEntityList('customTasks', 1000) },
