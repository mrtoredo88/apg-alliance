...
export function MapPage({ partners = [], onBack, onOpenPartner }) {
  ...
  return (
    <Panel id="map">
      {/* Хедер */}
      <div style={{ position: 'sticky', top: 'var(--safe-top, 0px)', zIndex: 60, background: 'rgba(8,8,20,0.72)', backdropFilter: 'blur(36px) saturate(2)', WebkitBackdropFilter: 'blur(36px) saturate(2)', borderBottom: '1px solid rgba(255,255,255,0.1)', boxShadow: 'inset 0 -1px 0 rgba(0,0,0,0.2)', padding: '0 16px' }}>
