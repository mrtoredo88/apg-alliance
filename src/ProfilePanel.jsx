...
const FAQ_ITEMS = [
  ...
  {
    q: 'Зачем нужны ключи?',
    a: 'Ключи открывают доступ на закрытые мероприятия АПГ — они проходят раз в квартал и доступны только участникам с нужным количеством ключей.\n\nСобирай ключи за визиты к партнёрам и выполнение заданий. Они не сгорают.\n\nУровни — твои достижения в АПГ:\n🌱 Новичок (0 ключей)\n⭐️ Участник (10+)\n🔥 Активный (25+)\n💎 Профи (50+)\n👑 Амбассадор АПГ (100+)',
  },
  {
