          ...
          try {
            ...
            if (docSnap.exists()) {
              ...
              const syncExistingPayload = {
                ...
                referralSessionId: existingReferralContext.referralSessionId || existingReferralContext.sessionId,
              ...
              const syncResult = await userAction('profile:sync', {
                ...
                referralSessionId: newReferralContext.referralSessionId || newReferralContext.sessionId,
  ...
  const handleEmailAuthSuccess = useCallback(async (emailUser, authPayload = {}) => {
    ...
    try {
      ...
      const profileResult = await userAction('profile:sync', {
        ...
        referralSessionId: authPayload?.referralSessionId || emailReferralContext.referralSessionId || emailReferralContext.sessionId,
