          ...
          try {
            ...
            if (docSnap.exists()) {
              ...
              const syncExistingPayload = {
                ...
                referralSessionId: existingReferralContext.referralSessionId || undefined,
              ...
              const syncResult = await userAction('profile:sync', {
                ...
                referralSessionId: newReferralContext.referralSessionId || undefined,
  ...
  const handleEmailAuthSuccess = useCallback(async (emailUser, authPayload = {}) => {
    ...
    try {
      ...
      const profileResult = await userAction('profile:sync', {
        ...
        referralSessionId: authPayload?.referralSessionId || emailReferralContext.referralSessionId || undefined,
