export const LEARNING_VERSION = '2.0';

export const LEARNING_ONBOARDING_SLIDES = [
  {
    accent: '#C9A84C',
    orb: 'rgba(201,168,76,0.12)',
    tag: '1 из 6 · ГОРОДСКОЙ СЕРВИС',
    title: 'Весь полезный\nЗеленоград — рядом',
    desc: 'Места, события, эксперты и городские новости в одном понятном приложении для жителей.',
    visual: 'city',
  },
  {
    accent: '#4A90D9',
    orb: 'rgba(74,144,217,0.12)',
    tag: '2 из 6 · МЕСТА И СОБЫТИЯ',
    title: 'Решай, куда пойти\nи что попробовать',
    desc: 'Смотри партнёров, акции и афишу. Сохраняй интересное в профиль, чтобы вернуться позже.',
    visual: 'city',
    chips: ['Партнёры и акции', 'Афиша', 'Избранное'],
  },
  {
    accent: '#E8C97A',
    orb: 'rgba(232,201,122,0.1)',
    tag: '3 из 6 · ЛЮДИ И ОБЩЕНИЕ',
    title: 'Знакомься\nи оставайся на связи',
    desc: 'Находи участников АПГ, общайся в сообщениях и получай важные обновления в уведомлениях.',
    visual: 'social',
    chips: ['Люди', 'Сообщения', 'Уведомления'],
  },
  {
    accent: '#4BB34B',
    orb: 'rgba(75,179,75,0.1)',
    tag: '4 из 6 · КЛЮЧИ И НАГРАДЫ',
    title: 'Будь активным —\nполучай ключи',
    desc: 'Сканируй QR у партнёров и выполняй задания. Ключи открывают подарки, билеты и другие возможности АПГ.',
    visual: 'rewards',
    chips: ['QR у партнёров', 'Задания', 'Подарки'],
  },
  {
    accent: '#C9A84C',
    orb: 'rgba(201,168,76,0.12)',
    ...
    tag: '5 из 6 · ПОМОЩНИК ЛОКИ',
    title: 'Не знаешь, с чего начать?\nСпроси Локи',
    desc: 'Он объяснит экран, подберёт место или событие и подскажет следующий полезный шаг.',
    visual: 'loki',
  },
  {
    accent: '#4BB34B',
    orb: 'rgba(75,179,75,0.1)',
    tag: '6 из 6 · ТВОЙ ПЕРВЫЙ ШАГ',
    title: 'Что интересно\nпрямо сейчас?',
    desc: 'Выбери одно действие. Остальное всегда найдёшь на главной и в профиле — вместе с прогрессом, приглашениями и настройками.',
    visual: 'actions',
  },
];
...
export const LEARNING_HINTS = {
  ...
  offers: {
    id: 'partners_catalog',
    title: 'Акции партнёров и экспертов',
    text: 'Выбери предложение и открой профиль партнёра или эксперта, который его разместил.',
  },
  events: {
    id: 'events_agenda',
    title: 'Афиша событий',
