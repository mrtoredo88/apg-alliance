...
import salesAiRoutes          from './routes/sales-ai.js';
import salesAiAgentRoutes     from './routes/sales-ai-agents.js';
...
fastify.register(salesAiRoutes);
fastify.register(salesAiAgentRoutes);
