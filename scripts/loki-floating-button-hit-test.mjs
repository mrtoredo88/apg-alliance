...
assert.match(source, /if \(loki\.settings\.dockedToHeader\)[\s\S]*floatingPeopleAndMessages/, 'Docked Loki must leave the independent communication buttons mounted.');
