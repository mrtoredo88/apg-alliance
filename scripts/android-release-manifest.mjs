...
const manifest = {
  ...
  releaseNotes: [
    'Обновление APK теперь загружается прямо внутри приложения.',
    'Добавлены прогресс загрузки и проверка целостности файла.',
    'После загрузки открывается безопасное системное окно установки Android.',
  ],
};
