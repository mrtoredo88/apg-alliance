...
const manifest = {
  ...
  releaseNotes: [
    'Исправлен голосовой ввод Локи в Android-приложении.',
    'Добавлен системный запрос разрешения на использование микрофона.',
    'Уточнён статус фоновых уведомлений в APK.',
  ],
};
