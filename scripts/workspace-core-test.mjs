...
assert.deepEqual(mobileNav.primary.map(item => item.id), ['home', 'offers', 'scan', 'events', 'profile']);
...
assert.deepEqual(superAdminMobileNav.primary.map(item => item.id), ['home', 'offers', 'scan', 'events', 'profile']);
assert.deepEqual(superAdminMobileNav.primary.map(item => item.panelId), ['home', 'offers', null, 'events', 'profile']);
...
assert.deepEqual(USER_MODE_NAV_ITEMS.map(item => item.id), ['home', 'offers', 'scan', 'events', 'profile']);
