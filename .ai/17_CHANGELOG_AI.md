...
**Дополнительно:** При открытии события внутренний scroll карточки принудительно возвращается в начало, чтобы пользователь сразу видел большую hero-обложку, а не середину карточки после предыдущих взаимодействий.
