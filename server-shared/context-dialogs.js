...
export function buildDialogContext(type, item = {}, extra = {}) {
  ...
  return {
    ...
    time: firstText(item.time, item.startTime),
    ...
    rating: firstText(item.rating, item.stars, item.avgRating),
    openNow: firstText(item.openNowLabel, item.openNow),
    locationTitle: firstText(item.locationTitle, item.locationName),
    nearestLocation: firstText(item.nearestLocation),
    promotionTitle: firstText(item.promotionTitle, item.offerTitle, item.offer),
    discount: firstText(item.discount, item.discountText, item.benefit),
    validUntil: firstText(item.validUntil, item.endsAt, item.endDate),
    author: firstText(item.author, item.authorName),
    freePlaces: firstText(item.freePlaces, item.availableSeats, item.capacityLeft),
    participantsCount: firstText(item.participantsCount, item.registeredCount),
    bookingUrl: firstText(item.bookingUrl, item.onlineBookingUrl),
    ownerUserIds,
